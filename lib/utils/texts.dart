...
class AppTexts {
  ...
  static const String reviewTerms =
      'Your reviews, ratings and name may be posted publicly on Microsoft and/or '
      'third-party applications and websites. By submitting a review, you agree to '
      'the';
  static const String reviewTitle = 'Give a title to your review (Optional)';
  static const String reviewTitleHint = 'Enter title';
